...
<body style="background-color: gray;">
    ...
    <div class="container-fluid">
        ...
        font-family: 'Times New Roman';">
                ...
                $result = $conn->query("SELECT * FROM `account` WHERE `role`='Owner' limit $start_from,$num_per_page");
                ...
                <div class="co-lg-12" style="text-align: right;">
                    <div style="margin-right: 10%;">
                        ...
                        <?php
                        $pr_query = "SELECT * FROM `account` WHERE `role`='Owner'";
                        ...
                        if ($page > 1) {
                            echo "<a href='http://localhost/hrms/View/user_list.php?page=" . ($page - 1) . "' class='btn btn-danger'>Previous </a>";
                        }

                        for ($i = 1; $i < $total_page; $i++) {
                            echo "<a href='http://localhost/hrms/View/user_list.php?page=" . $i . "' class='btn  btn-primary'>$i</a>";
                        }

                        if ($i > $page) {
                            echo "<a href='http://localhost/hrms/View/user_list.php?page=" . ($page + 1) . "'class='btn btn-danger'> Next</a>";
                        }
                        ?>
                    </div>
                </div>
