    ...
    <?php
      ...
      <div class="col-lg-9 rounded  bg-light body1">
        ...
        <div id="about" class="rounded" style="margin-top: 2%;">
          ...
          font-weight: bold; 
          font-family: 'Times New roman';">
          <center><b>Mission</center></b>Our mission is to provide the most complete, reliable, and reasonably priced service with the aid of technology and well qualified 
 professionals and high sense of commitment to satisfy their customers.
  <br></br>  <br></br>  <br></br> <br></br> <strong><center>Thank you for visiting our site!</strong>
