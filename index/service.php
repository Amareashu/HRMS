    ...
    <?php
      ...
      <div class="col-lg-9 rounded  bg-light body1">
        ...
        <div id="about" class="rounded" style="margin-top: 2%;">
          ...
          font-weight: bold; 
          font-family: 'Times New roman';">
            The Service of the project can be seen in many directions as:-
          <p>
            The systems uses login method
          </p>
          <p>
            Register house rental menagement system supporter admin
          <p/>
           <p>
        ...
        <p>
            By minimize utilization of time for entry that are lost during searching information
		  	...
		  	<P>  make suitable condition for the customer and the owner.</P>
          <p>
            Capable of providing high data security and reliability to prevent data loss.

          </p>
          <p>
            By decreasing the use of material and manpower.

          </p>
          <p>
            By improving the utilization of  properties.
          </p>
          <p>
            The system notify is there is new inbox letters and approved notice<h4/>
          </p>
<h4/>
        </div>
        <br>
