    ...
    <?php
      ...
      <div class="col-lg-9 rounded  bg-light body1">
        ...
        <div id="about" class="rounded" style="margin-top: 2%;">
          ...
          font-weight: bold; 
          font-family: 'Times New roman';">
           	<center><b>Vission</center></b>
To become  open up  and world class complete house renting service provider and earn the respect of all owners ,customers ,employees and community at large.
          <p>
           <br></br>  <br></br>  <br></br> <strong><center>Thank you for visiting our site!</strong>
          </p>
